                    ...
                    try {
                        ...
                        stream.on("end", () => {
                            const checkAndEndStream = () => {
                                if (chunks.length === 0 && !sourceBuffer.updating) {
                                    mediaSource === null || mediaSource === void 0 ? void 0 : mediaSource.endOfStream();
                                    resolve(void 0);
                                }
                                else {
